            ...
            @forelse ( $facturas as $fac)
                <tr>
                    ...
                    <td>
                        ...
                        @if ($fac->uso_cafc == 'Si')
                            <a href="{{ $fac->empresa->url_verifica."?nit=".$fac->nit."&cuf=".$fac->cuf."&numero=".$fac->numero_cafc."&t=2" }}" target="_blank" class="btn btn-icon btn-sm tamanio_boton"><img src="{{ asset('assets/img/siat.png') }}" style="width: 25px;" alt=""></a>
                        @else
                            <a href="{{ $fac->empresa->url_verifica."?nit=".$fac->nit."&cuf=".$fac->cuf."&numero=".$fac->numero_factura."&t=2" }}" target="_blank" class="btn btn-icon btn-sm tamanio_boton"><img src="{{ asset('assets/img/siat.png') }}" style="width: 25px;" alt=""></a>
                        @endif
