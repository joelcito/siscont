            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y">
                    <form id="formulario_new_servicio">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-success w-100 btn-sm" onclick="guardarNewServioEmpresaFormularioFacturacion()">Generar</button>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <form id="formulario_venta">
                                ...
                                <div class="row" style="display: none;" id="bloque_mas_datos_productos">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control form-control-sm" name="descripcion_adicional" id="descripcion_adicional" cols="30" rows="1"></textarea>
                                    </div>
                                </div>
                            </form>
                            <hr>
...
@section('js')
    ...
    <script>
        ...
        function guardarNewServioEmpresaFormularioFacturacion(){
                    ...
                    success: function (data) {
                        if(data.estado === 'success'){
                            ...
                            $.each(nuevosServicios, function(index, servicio) {
                                ...
                                select.append('<option value=\'' + d + '\'>' + servicio.descripcion + '</option>');
                            });
