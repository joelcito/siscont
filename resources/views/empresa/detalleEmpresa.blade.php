        ...
        <div class="modal-dialog modal-dialog-centered mw-400px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6">
                            <button class="btn btn-sm btn-success w-100" onclick="guardarPuntoVentaEmpresa()">Guardar</button>
                        </div>
                        <div class="col-md-6">
                    ...
                    <form id="formulario_new_usuario_empresa">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <select data-control="select2" data-placeholder="Seleccione" data-dropdown-parent="#modal_new_usuario" data-hide-search="true" class="form-select form-select-solid fw-bold" name="rol_id_new_usuaio_empresa" id="rol_id_new_usuaio_empresa" required>
                                    <option></option>
                                    @foreach ($roles as $r)
                                ...
                                <form id="formulario_empresa" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control fw-bold form-control-solid form-control-sm" name="nombre_empresa" id="nombre_empresa" value="{{ $empresa->nombre }}" required disabled>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" class="form-control fw-bold form-control-solid form-control-sm" name="nit_empresa" id="nit_empresa" value="{{ $empresa->nit }}" required disabled>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="fs-6 fw-semibold form-label mb-2">Razon Social</label>
                                            <input type="text" class="form-control fw-bold form-control-solid form-control-sm" name="razon_social" id="razon_social" value="{{ $empresa->razon_social }}" required disabled>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="fs-6 fw-semibold form-label mb-2">Municipio</label>
                                            <input type="text" class="form-control fw-bold form-control-solid form-control-sm" name="municipio" id="municipio" value="{{ $empresa->municipio }}" required disabled>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="fs-6 fw-semibold form-label mb-2">Celular</label>
                                            <input type="number" class="form-control fw-bold form-control-solid form-control-sm" name="celular" id="celular" value="{{ $empresa->celular }}" required disabled>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
                                        <div class="col-md-3">
                                            <label class="fs-6 fw-semibold form-label mb-2">Ambiente</label>
                                            <select data-control="select2" data-placeholder="Seleccione" data-hide-search="true" class="form-select form-select-solid fw-bold form-control-sm" name="codigo_ambiente" id="codigo_ambiente" required disabled>
                                                <option></option>
                                                <option value="2" {{ ($empresa->codigo_ambiente == 2)? 'selected' : '' }}>Desarrollo</option>
                                                <option value="1" {{ ($empresa->codigo_ambiente == 1)? 'selected' : '' }}>Produccion</option>
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            <label class="fs-6 fw-semibold form-label mb-2">Modalidad</label>
                                            <select data-control="select2" data-placeholder="Seleccione" data-hide-search="true" class="form-select form-select-solid fw-bold form-control-sm" name="codigo_modalidad" id="codigo_modalidad" required disabled>
                                                <option></option>
                                                <option value="1" {{ ($empresa->codigo_modalidad == 1)? 'selected' : '' }}>Electronica en Linea</option>
                                                <option value="2" {{ ($empresa->codigo_modalidad == 2)? 'selected' : '' }}>Computarizada en linea</option>
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control fw-bold form-control-solid form-control-sm" name="codigo_sistema" id="codigo_sistema" value="{{ $empresa->codigo_sistema }}" required disabled>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control fw-bold form-control-solid form-control-sm" name="api_token" id="api_token" value="{{ $empresa->api_token }}" required autocomplete="username" disabled>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
...
@section('js')
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.estado === 'success'){
                            ...
                            }, 2000); // Espera 300 ms antes de ejecutar la función
                        }else{
        ...
        function guardarPuntoVentaEmpresa(){
            ...
            if($("#formulario_punto_venta")[0].checkValidity()){
                ...
                $.ajax({
                    url   : "{{ url('empresa/guardarPuntoVentaEmpresa') }}",
                    method: "POST",
                    data  : datos,
                    success: function (data) {
        ...
        function guardarSucursal(){
            if($("#formulario_sucursal")[0].checkValidity()){
                ...
                $.ajax({
                    url   : "{{ url('empresa/guardaSucursalEmpresa') }}",
                    method: "POST",
                    data  : datos,
                    success: function (data) {
                        if(data.estado === 'success'){
        ...
        function sincronizarSiatProductoServicios(punto_venta, sucursal){
            ...
            // Bloquear el botón
            $('#botom_sincronizarSiatProductoServicios').prop('disabled', true);
            // Añadir la clase fa-spin para que el icono gire
            $('#icono_sincronizarSiatProductoServicios').addClass('fa-spin');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // Bloquear el botón
                    $('#botom_sincronizarSiatProductoServicios').prop('disabled', false);
                    // Añadir la clase fa-spin para que el icono gire
                    $('#icono_sincronizarSiatProductoServicios').removeClass('fa-spin');
                }
            })
        }
            ...
            Swal.fire({
                ...
                confirmButtonText : "Si, eliminar!"
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url   : "{{ url('empresa/eliminarSucursalEmpresa') }}",
                            method: "POST",
                            data  : datos,
                            success: function (data) {
                                if(data.estado === 'success'){
        ...
        function agregarUsuarioEmpresa(){
            ...
            $('#rol_id_new_usuaio_empresa').val(null).trigger('change')
            $('#sucursal_id_new_usuaio_empresa').val(null).trigger('change')
            $('#bloque_tabla_punto_ventas_new_usuario_empresa').text('')

            $('#contrasenia_new_usuaio_empresa').attr('required', true)
        ...
        function guardarUsuarioEmpresa(){
            if($("#formulario_new_usuario_empresa")[0].checkValidity()){
                ...
                $.ajax({
                    url   : "{{ url('empresa/guardarUsuarioEmpresaEmpresa') }}",
                    method: "POST",
                    data  : datos,
                    success: function (data) {
                        if(data.estado === 'success'){
            ...
            Swal.fire({
                ...
                confirmButtonText : "Si, eliminar!"
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url   : "{{ url('empresa/eliminarUsuarioEmpresa') }}",
                            method: "POST",
                            data  : datos,
                            success: function (data) {
                                if(data.estado === 'success'){
